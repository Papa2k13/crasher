...
setTimeout(async () => {
let code = await XeonBotInc.requestPairingCode(phoneNumber, 'MRLEGEND');
...
require("./WhatsApp")(XeonyConnect, mek, chatUpdate, store);
} catch (err) {
console.log(err);
}
});
...
XeonBotInc.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
        ...
        if (reason === DisconnectReason.badSession) {
            ...
            deleteFolderRecursive(`./AllSessions/Pair-Session/${xeonNumber}`);
